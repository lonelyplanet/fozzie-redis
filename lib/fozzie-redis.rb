...
module FozzieRedis
  ...
  INTERESTING_KEYS_REGEX = %w(mem_fragmentation_ratio total_connections_received total_commands_processed expired _keys keyspace ^db memory$ memory_rss$ memory_peak$ )
